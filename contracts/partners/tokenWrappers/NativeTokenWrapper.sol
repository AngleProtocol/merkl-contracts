...
contract NativeTokenWrapper is UUPSHelper, ERC20Upgradeable {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 amount) internal override {
        // During claim transactions, native gas tokens (ETH) are transferred to the `to` address
    ...
    function recoverETH(address payable _to, uint256 amount) external onlyMinterOrGovernor {
