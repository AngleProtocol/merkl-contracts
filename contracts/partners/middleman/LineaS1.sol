...
/// @notice Middleman contract enabling authorized executors to create LineaS1 airdrop campaigns on Merkl
...
contract LineaS1 is Ownable {
    ...
    /// @dev Can technically create multiple campaigns, but realistically should just create one
    ...
    /// @notice Sets the allowance for a token to a specific spender
    /// @dev Allows the owner to manage token approvals from this contract
