...
contract UpgradeDistributorTest is Test {
    ...
    function _setupUpgradeTest() internal {
        ...
        try IDistributorWithCore(address(distributor)).core() returns (address coreAddress) {
            ...
            accessControlManager = AccessControlEnumerableUpgradeable(address(distributor.accessControlManager()));
        }
    ...
    function test_VerifyStorageSlots_Success() public {
        ...
        assertEq(address(distributor.accessControlManager()), preUpgrade_accessControlManager, "AccessControlManager should remain unchanged");
    ...
    function test_UpdateTree_Success_WhenAuthorizedUpdater() public {
        ...
        MerkleTree memory newTree = MerkleTree({ merkleRoot: keccak256(abi.encodePacked("new_test_root")), ipfsHash: bytes32(0) });
    ...
    function test_UpdateTree_Revert_WhenUnauthorized() public {
        ...
        // Create new merkle tree
        MerkleTree memory newTree = MerkleTree({ merkleRoot: keccak256(abi.encodePacked("unauthorized_root")), ipfsHash: bytes32(0) });
    ...
    function test_UpdateTree_Revert_WhenDisputePeriodNotOver() public {
        ...
        // Create new merkle tree
        MerkleTree memory newTree = MerkleTree({ merkleRoot: keccak256(abi.encodePacked("early_root")), ipfsHash: bytes32(0) });
