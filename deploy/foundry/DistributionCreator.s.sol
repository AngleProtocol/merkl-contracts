...
contract Deploy is DistributionCreatorScript {
    function run() external broadcast {
        ...
        uint256 defaultFees = readUint(chainId, "Merkl.DefaultFees");
...
// forge script deploy/foundry/DistributionCreator.s.sol:CreateCampaign \
// --rpc-url lisk \
...
// forge script deploy/foundry/DistributionCreator.s.sol:CreateCampaigns \
// --rpc-url lisk \
